...
public class BaseTest {
	...
	public static int TestCaseRow;
	 ...
	 public void startTest(String ExcelFilePath, String ExcelSheetName){
		 ...
		 try{
			 ...
			 System.setProperty("webdriver.chrome.driver","/Users/jahdielreeve/Documents/Automation/Drivers/chromedriver");
	...
	public void takescreenshot() throws IOException{
		...
		FileUtils.copyFile(scrFile, new File("/Users/jahdielreeve/Downloads/Workspace/SeleniumProject/test-reports/screenshots/"+ getFileName(this.getClass().getSimpleName())));
		} catch (Exception e){
	...
	//method to check the text in the element or verify text
